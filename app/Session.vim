...
badd +63 admin.py
badd +1 views/indexview.py
badd +1 views/__init__.py
badd +1 static/custom.css
badd +1 templates/index.jiras_panel.html
badd +1 templates/index.services_panel.html
badd +0 views/marqueeview.py
...
silent! normal! zE
let s:l = 102 - ((58 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
102
normal! 0
tabedit templates/index.services_panel.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal! 046|
tabedit templates/index.jiras_panel.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((14 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
normal! 0
tabedit views/marqueeview.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
